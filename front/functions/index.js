...
const serviceAccountCert = require("./serviceAccount.json"); // ADD THIS FILE FROM FIREBASE ADMIN PANEL
...
exports.requestMessage = functions.https.onCall(async (data) => {
    await Moralis.start({
      apiKey: "8WrPS3leJvDAIlCBaVzQh10oLpwHLmEdilDsdOnnJ0KWOmTR8sBpgGLxpDMRvL3Q",
    });
