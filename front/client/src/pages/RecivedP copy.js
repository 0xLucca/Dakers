...
const RecivedP = () => {
    ...
    const {activePublications, handleAcceptPublication ,allUsers} = useContext(FirebaseContext);
        ...
        <div className="min-h-screen font-poppins">
            <div>
                <div className='w-10/12 md:w-8/12 m-auto'>
                    ...
                    <button className='px-4 py-1.5 bg-green-500 hover:bg-green-700 transition duration-150 font-semibold rounded text-slate-50' onClick={()=>{handleAcceptPublication(thisP,id)}}>aceptar</button>
